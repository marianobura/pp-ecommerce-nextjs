    ...
    <div className="sticky top-8 w-36 md:w-64">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex border-spacing-y-2 flex-col divide-y divide-neutral-200">
          <AccordionItem summary="Category">
                  ...
                  >
                    <div
                      className={`flex size-4 shrink-0 items-center justify-center rounded-4xl border transition-colors ${
                        isActive ? 'border-primary bg-primary' : 'border-neutral-700'
                      }`}
                    >
          ...
          <AccordionItem summary="Price" className="pt-2">
          ...
          <AccordionItem summary="Rating" className="pt-2">
            <div className="flex flex-col gap-2">
          ...
          <AccordionItem summary="Discount" className="pt-2">
            <div className="flex flex-col gap-2">
              <div
